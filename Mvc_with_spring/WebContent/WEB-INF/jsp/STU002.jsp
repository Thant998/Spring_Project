...
<body>
    ...
    <div id="sub_content">
		  ...
		  <form:form action="/acetest/updateStudent" method="post" modelAttribute="stuBean" >
            ...
            <div class="row mb-4">
						...
						<label for="studentID" class="col-md-2 col-form-label">Student
							ID</label>
						<div class="col-md-4">
						<form:input type="text"  class="form-control"  id="studentID" path="id" /> 
						...
						<div class="col-md-4">
							<div class="form-check-inline">
								<form:radiobutton class="form-check-input" 
									id="gridRadios1" value="Male" path="gender"/>
								<form:errors path="gender" style="color: red;"></form:errors>															
								<label class="form-check-label" for="gridRadios1"> Male	</label>					
							</div>
							<div class="form-check-inline">
								<form:radiobutton class="form-check-input" 
									id="gridRadios2" value="Female" path="gender"/>
            ...
            <div class="row mb-4">
						...
						<div class="col-md-4">
							<form:select class="form-select" aria-label="Education"
								...
								<form:option value="Diploma in IT">Diploma
									in IT</form:option>
        ...
        <button type="submit"class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal">         
                Update      
                    ...
                    <a href="/acetest/deleteStudent/${stuBean.id}">
