...
<body>
    ...
    <div id="sub_content">
        <form:form action="/acetest/updateuser" method="post" modelAttribute="bean">
        ...
        <h2 class="col-md-6 offset-md-2 mb-5 mt-4">User Update</h2>
       		<div class="row mb-4">
                ...
                <div class="col-md-4">
                    <form:input type="text" class="form-control" id="id" path="userId"/>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    ...
                    <form:errors path="userPassword" style="color: red;"></form:errors>
                </div>
            </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-6">
                ...
                <input type="submit" value="Update" class="btn btn-success col-md-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
                
            <button type="button" class="btn btn-secondary col-md-2 " onclick="location.href = '/acetest/showuser';">
                Back
            </button>
